                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center mb-16">
                    ...
                    >
                        ...
                        <div className="space-y-4 text-gray-700 leading-relaxed">
                            <p>
                                Advogada com sólida vivência no mercado financeiro, com mais de sete anos de experiência
                                no setor bancário, onde desenvolveu expertise em análise e gestão de Crédito Rural. Com
                                atuação destacada na administração de mais de R$ 3 bilhões em recursos e definição de
                                taxas de juros, possui domínio técnico dos fluxos internos das instituições financeiras,
                                garantindo um diferencial estratégico ao identificar soluções precisas para as demandas
                                de produtores rurais junto ao sistema bancário e demais financiadoras.
                            </p>

                            <p>
                                Graduada em Direito pela Pontifícia Universidade Católica de Goiás (PUC-GO) é
                                pós-graduanda em Direito Agrário e do Agronegócio, possui a certificação FBB420 (Crédito
                                Rural) pela Febraban, credencial que atesta seu domínio técnico sobre as diretrizes do
                                Manual de Crédito Rural (MCR), o Sistema Nacional de Crédito Rural (SNCR) e os programas
                                governamentais de financiamento agropecuário.
                            </p>
